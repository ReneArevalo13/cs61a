...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    x_city1, x_city2 = get_lat(city1), get_lat(city2)
    y_city1, y_city2 = get_lon(city1), get_lon(city2)
    return sqrt((x_city1 - x_city2)**2 + (y_city1 - y_city2)**2)
...
def closer_city(lat, lon, city1, city2):
    ...
    distance1 = distance(city0, city1)
    distance2 = distance(city0, city2)
