...
def taxicab(a, b):
    ...
    ave_a, ave_b = avenue(a), avenue(b)
    diff_street,diff_ave  = abs(street_a - street_b), abs(ave_a - ave_b)
     
    return diff_ave + diff_street
...
def balanced(m):
    ...
    if is_mobile(m):
        ...
        torque_left = left_length * left_weight
        torque_right = right_length * right_weight
        return torque_left == torque_right and balanced(end(left_arm)) and balanced(end(right_arm))
